...
// workplace advice array with 20 advice quotes
...
// financial advice array with 20 advice quotes
...
// health advice array with 20 advice quotes
const health_advice = [
    "Be physically active for at least 30 minutes most days of the week.",
    "Eat a well-balanced, low-fat diet rich in fruits, vegetables, and whole grains.",
    ...
    "Prioritize sleep by establishing a regular sleep schedule and by creating a relaxing bedtime routine.",
    "Start your day with a glass of water to aid digestion and boost energy.",
    "Take regular breaks from screen time to reduce eye strain.",
    "Incorporate real, whole foods into your diet and avoid processed items.",
    "Consider taking a multivitamin to supplement your nutritional intake.",
    "Exercise regularly to improve mood, concentration, and overall health.",
    "Limit alcohol consumption and avoid smoking.",
    "Stay connected with friends and family for emotional support.",
    "Set realistic goals and priorities to manage stress effectively.",
    ...
    "Use stress management techniques such as journaling or deep breathing exercises.",
    "Limit intake of sugary drinks and opt for healthier options like water or unsweetened tea.",
    "Get regular health check-ups and screenings as recommended by your healthcare provider.",
